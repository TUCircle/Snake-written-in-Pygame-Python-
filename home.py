...
sound = pygame.mixer.Sound('Soundeffects/apple.wav')
...
def game_intro():
    ...
    while intro:
        ...
        message_to_screen('Welcome!', green , y_displace= -100, size='large')
        message_to_screen('Press any Key to start!',red, y_displace = 30, size='medium')
        message_to_screen('(P = Pause     T  =  Music on/off)',black,y_displace = 230,x_displace = 0, size='small')
...
def gameLoop():
    ...
    global musicOn
    #controling the music managment
    ...
    while not gameExit:
        ...
        while gameOver == True:
            gameDisplay.fill(white)
            message_to_screen('Game Over',black,0,-50,size='large')
            message_to_screen('Press Q to quit and C to continue',red,0,50,size='small')
            pygame.display.update()
        ...
        gameDisplay.fill(white)
        #drawing the apple
        message_to_screen(('Score: ' + str(snakeLength-1)),black,-350,-270)
